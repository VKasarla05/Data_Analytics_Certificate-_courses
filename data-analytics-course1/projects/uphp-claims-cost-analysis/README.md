...
## Status
🚧 In progress — Ask, Prepare, Process, and Analyze complete; moving into Share.
...
(Kaggle, synthetic, 4,500 claims) — member-level claims data: demographics, diagnosis/
procedure info, claim amounts, and dates.
...
## Folders
- `data/` — raw and cleaned data files (raw data itself is gitignored; see `data/README.md`)
- `analysis/` — spreadsheets, pivot tables, charts, working files
